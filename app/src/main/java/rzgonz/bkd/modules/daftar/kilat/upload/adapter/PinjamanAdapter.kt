...
class PinjamanAdapter(context: Context, users: List<PinjamanItem?>) : ArrayAdapter<PinjamanItem?>(context,R.layout.row_spinner, users) {
    // View lookup cache
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.name?.setText(user?.nominalPinjaman)
