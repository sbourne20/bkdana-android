package rzgonz.bkd.modules.profile.adapter
...
class ProvinsiAdapter(context: Context, banks: List<ProvinsiItem?>) : ArrayAdapter<ProvinsiItem?>(context, R.layout.row_spinner, banks) {
    // View lookup cache
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        viewHolder.name?.setText("${bank?.provinceName}")
        // Return the completed view to render on screen
        return convertView
    }

    override fun getItem(position: Int): ProvinsiItem? {
