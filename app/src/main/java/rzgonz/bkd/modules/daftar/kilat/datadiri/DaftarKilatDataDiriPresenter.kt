...
class DaftarKilatDataDiriPresenter @Inject constructor(context: Context) : DIBasePresenter<DaftarKilatDataDiriContract.View>(),DaftarKilatDataDiriContract.Presenter{
    ...
    override fun sendDataDiri(pendidikan: String, nama_perusahaan: String, telp_perusahaan: String, status_karyawan: String, lama_bekerja: String, nama_atasan: String, referensi_1: String, referensi_2: String) {
        apiService.sendKilat2(pendidikan,nama_perusahaan,telp_perusahaan,status_karyawan,lama_bekerja,nama_atasan,referensi_1,referensi_2)
